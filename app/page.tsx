  ...
  return (
    <section className="px-2">
      ...
      <div className="content mb-8 flex flex-col gap-y-4">
        <p>
          Hi! I am a student at Brown University studying computer science. I am
          particularly interested in computer networks, operating systems, and
          compilers.
        </p>
        <p>
          In the Brown CS department, I have worked as a{" "}
          <a href="https://cs.brown.edu/people/staff/spoc/">
            systems programmer
          </a>
          , a{" "}
          ...
          <a href="https://browncs1715.github.io/">
            Formal Proof and Verification
          </a>{" "}
          (TA Fall 2024, HTA Fall 2025),{" "}
          <a href="https://csci0300.github.io/">Computer Systems</a> (TA Spring
          2025),{" "}
          <a href="https://cs.brown.edu/courses/csci1515/">
            Applied Cryptography
          </a>{" "}
          (HTA Spring 2026), and{" "}
          <a href="https://csci1670.github.io/">Operating Systems</a> (HTA Fall
          2026). I also run tech for{" "}
          <a href="https://brownpuzzlehunt.com/">Brown Puzzlehunt</a>.
        </p>
        <p>
          In my free time, I like to <Link href="/fiction">read</Link>,{" "}
          <Link href="/writings">write</Link>, and go{" "}
          <Link href="/climbing">climbing</Link>.
        </p>
        <p>
          Brown students might find some of my{" "}
          <Link href="/courses">courses reviews</Link> useful.
        </p>
      </div>
