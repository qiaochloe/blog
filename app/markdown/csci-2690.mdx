...
6. [NIC Interfaces](#nic-interfaces)
    - Background: [Packetized Interface](#packetized-interface)
    - Papers: [Enso](#enso)
7. [CPU Scheduling](#cpu-scheduling)
    - Background
    - Papers: [Shenango](#shenango), [Attack of the Killer Microseconds](#attack-of-the-killer-microseconds)
8. [CPU Scheduling (cont.)](#cpu-scheduling-cont)
    - Background:
    - Papers: [Syrup](#syrup), [Ghost](#ghost), [Caladan](#caladan)
9. [Signals vs. Interrupts](#signals-vs-interrupts)
    - Background:
    - Papers: [Aspen](#aspen)
10. [Warehouse-Scale Memory Management](#warehouse-scale-memory-management)
