...
1. [Basic Concepts](#basic-concepts) 
    ...
    - [Memory](#memory)
    - [Processes Address Space](#process-address-space)
    - [Process Execution](#process-execution)
    - [Registers](#registers)
    - [x86 Instructions](#x86-instructions)
    - [Exploitation Tools](#exploitation-tools)
2. [Control-Flow Hijacking](#control-flow-hijacking)
3. [Code Injection](#code-injection)
    - [NOP Sled](#nop-sled)
    - [jmp %esp](#jmp-esp)
    - [Register Spring](#register-spring)
...
7. [Full ASLR | Just-In-Time Code Reuse](#full-aslr-just-in-time-code-reuse)
    ...
    - [Just-In-Time Code Reuse](#just-in-time-code-reuse)
...
9. [Toolchain-Based Hardening](#toolchain-based-hardening)
    ...
    - [x86 Segmentation](#x86-segmentation)
    - [Memory Disclosure (Cont.)](#memory-disclosure-cont)
    - [RELRO and Bindnow](#relro-and-bindnow)
