...
5. [Non-Executable Memory | Code Reuse](#non-executable-memory-code-reuse)
    - [Non-Executable Memory](#non-executable-memory) (10/8)
    - [mprotect](#mprotect) (10/8)
    - [system](#system) (10/15)
    - [ret2libc Chain](#ret2libc-chain) (10/15)
6. [Partial ASLR | Return-Oriented Programming](#partial-aslr-return-oriented-programming)
    - [Address Space Layout Randomization](#address-space-layout-randomization) (10/20)
    - [Dynamic Linking](#dynamic-linking) (10/27)
    - [Return-Oriented Programming](#return-oriented-programming) (10/27)
7. [Full ASLR | Just-In-Time Code Reuse](#full-aslr-just-in-time-code-reuse)
    - [Full ASLR](#full-aslr) (10/29)
    - [Memory Disclosure](#memory-disclosure) (10/29)
    - [Just-In-Time Code Reuse](#just-in-time-code-reuse) (11/3)
8. [Advanced Code Reuse](#advanced-code-reuse)
    - [Stack Pivoting](#stack-pivoting) (11/5)
9. [Toolchain-Based Hardening](#toolchain-based-hardening)
    - [Stack Canaries](#stack-canaries) (11/10)
    - [x86 Segmentation](#x86-segmentation) (11/10)
    - [Memory Disclosure (Cont.)](#memory-disclosure-cont) (11/12)
    - [RELRO and Bindnow](#relro-and-bindnow) (11/19)
    - [FORTIFY_SOURCE](#fortify_source) (11/19)
