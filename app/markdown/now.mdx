...
I am working as a SPOC (Systems Programmer, Operator, and Consultant) for my dear department's TStaff.
...
I have been really enjoying going to the gym, climbing, and playing DDR this summer. It's a great way to fill up free time.

If you're around Providence and want to go climbing at some point, hit me up.

## Letting (as opposed to 'subletting')

I'm leasing an apartment with my friends [Aren](https://arenguralp.com/) and Jason. We'll also have [Alex W](https://awang127.qiaochloe.com) around over the summer (affectionately "the W" or "the Engineer"). This is actually the group of people I spent last summer with (see [summer 2024](/summer-2024-now)).

## Puzzle Club

[bph-site](https://github.com/brown-puzzle-hq/bph-site) is the open-source site we run [Puzzlethon](https://puzzlethon.brownpuzzle.club/) and [BPH 2025](https://www.brownpuzzlehunt.com/) on. We're actively developing it for MIT Mystery Hunt Prehunt 2026.
