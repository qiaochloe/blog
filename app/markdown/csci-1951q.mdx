...
3. [Program Semantics](#high-level-program-semantics)
    - [Syntax](#syntax)
    - [Semantics](#semantics)
    - [Type Safety](#type-safety)
4. [Type Inference](#type-inference)
5. [Intraprocedural Dataflow Analysis](#intraprocedural-dataflow-analysis)
    - [Dataflow Analysis](#dataflow-analysis)
    - [Monotonic Frameworks](#monotonic-frameworks)
6. [Pointer Analysis](#pointer-analysis)
...
Abstract values can be represented with a **lattice** structure. Lattices have a **join** function $\sqcup$ which produces the least upper bound for any two elements. A set $\mathcal{L}$ is a join-semilattice if
