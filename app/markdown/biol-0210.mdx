...
1. While the volcano is on on the hotspot, it grows on layers of lava and ash. The slope from the summit to the shoreline average 7 degrees. Below the shoreline, the slope is even steeper because the water changes the viscosity and buoyancy of lava. This allows us to calculate the maximum heights reached during the growth phase. 
2. Due to plate tectonics, the volcano eventually moves off the hotspot and begins to subside and erode. Subsidence is rapid and can be calculated as a function of mass. 
3. Erosion is the projected initial elevation minus post-subsidence elevation.

Price and Clague found that there have been few times when there has been tall volcanoes in close proximity, and now is one of them.
...
Wallace noticed that taxa seemed to be restricted to one side or the other of an invisible line (called Wallace's line). For example, despite being widespread, tigers never crossed over the Malay peninsula. This line is real, but it's not a hard boundary. The transitional zone is called 'Wallacea.'  

![Wallace's line on tigers](/biol-0210/wallace-line-tiger.png)

When it was colder, there were ice caps, and sea levels were lower. This exposed land bridges between Asia and Australia, allowing species to migrate. However, there were even deeper ocean trenches between Bali and Lombok, preventing migration. As a result, the taxonomic composition in Australia is still very different from Asia.
...
There are actually multiples to increase fitness:
