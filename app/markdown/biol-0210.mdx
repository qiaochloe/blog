...
**Relatedness** is based on the most recent common ancestor (MRCA). Recency is measured in genealogical time, not calendar time.
...
The **crown group** is the MRCA of all living members of a clade, and all of its descendents. It is a type of monophyletic group that must have living descendents by definition.

The **pan group** is the crown group and all organisms that share an ancestor with the crown more recently than any other living organism.

The **stem group** is the pan group minus the crown group.
...
An animal is a monophyletic group of five clades:
...
4. Appearance of hox genes

    Hox genes are a group of related genes that control the body plan of an embryo. A relatively small change in Hox genes can lead to a large change in morphology, so this this is both necessary and sufficient for the large increase in disparity during the Cambrian explosion. The problem is that Hox genes existed before the Cambrian explosion, so it does not explain why the Cambrian explosion happened when it did.
