---
title: "How To Run Dance Dance Revolution on macOS"
summary: "The Situation • StepMania • Project OutFox • Enjoyable"
publishedAt: "2024-07-11"
tags:
  - "technical"
todo: include which pads work 
---
...
The problem is that the dance pad inputs are not correctly parsed _on OutFox_. A quick diagram:
...
[^1]: There _was_ a MacOS version of StepMania, but it no longer runs on MacOS 10.15 "Catalina" or higher.
