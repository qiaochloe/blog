...
4. [Cell Signaling](#cell-signaling)
5. [Endocrine System](#endocrine-system)
6. [Neurons, Synapses, and Signaling](#neurons-synapses-and-signaling)
...
6. [Nervous System](#nervous-system)
    - [Types of Nervous Systems](#types-of-nervous-systems)
    - [Activation Pathways](#activation-pathways)
7. [Visceral and Somatic Motor System](#visceral-and-somatic-motor-system)
8. [Cardiac System](#cardiac-system)
    - [Cardiac Excitement](#cardiac-excitement)
...
**Pacemaker** cells (autorhythmic) repeatedly polarize and depolarize 60-72 times each minute. Pacemaker cells are electrically coupled to muscle cells (contractile) through gap junctions, allowing them to trigger action potentials in the contractile cells. The action potentials in the contractile cells cause them to contract, pumping blood through the heart.

The atrium excites first. Then it travels to the AV node and down the septum. Lastly, it reaches the  ventricles.

**Systole** means muscle contraction and **diastole** means muscle relaxation. The AV valves are open during diastole and closed during systole. The semilunar valves are closed during diastole and open during systole.

## EKG

A EKG consists of three waves:
