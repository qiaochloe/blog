...
tags:
- notes
todo: cardiac ap, respiratory terms from lab 3
---
...
**Preload** is the end-diastolic volume. It is impacted by the venous return.

**Afterload** is the resistance the ventricles must overcome to eject blood. It is impacted by arterial pressure and total peripheral resistance.

Stroke volume is affected by preload, afterload, and sympathetic tone.
...
**Question**: How does air exit and enter the lungs?

The lungs are surrounded by the pleural cavity, which has a negative pressure. When the **diaphragm** and **intercostal muscles** contract, they expand the **thoracic cavity**, which decreases the pressure in the pleural cavity. This causes air to flow into the lungs. 

When the diaphragm and intercostal muscles relax, the thoracic cavity contracts, which increases the pressure in the pleural cavity. This causes air to flow out of the lungs.
...
Lung conditions:
1. **Normal lung.** PO2 in the alveoli and blood are around 100 mmHg.
2. **Emphysema**. Elastic fibers holding the small airways open are damaged, leading to difficulty breathing out. Additionally, the alveoli are damaged, so there is less surface area for gas exchange. This causes a decrease in PO2 in the blood.
3. **Fibrotic lung disease.** The alveoli are thickened, so there is a longer diffusion distance for gas exchange. This also causes a decrease in PO2 in the blood.
4. **Pulmonary edema**. There is fluid in the alveoli, which increases the diffusion distance for gas exchange. This also causes a decrease in PO2 in the blood.
5. **Asthma.** Increased resistance in the airways causes a decrease in airflow, which can lead to a decrease in PO2 in the alveoli and blood.

### Terms

**Alveolar ventilation** is the amount of air that reaches the alveoli per minute.

**Tidal volume** (TV) is the volume of air inhaled or exhaled during normal breathing. It is around 500 mL in adults.

**Dead space** is the volume of air that does not participate in gas exchange. It is around 150 mL in adults.
...
**Vital capacity** (VC) is the maximum amount of air that can be exhaled after a maximum inhalation. It is around 3-5 L in adults. 

**Total lung capacity** (TLC) is the maximum amount of air that the lungs can hold. It is around 6-7 L in adults.

**Residual volume** (RV) is the volume of air remaining in the lungs after a maximum exhalation. It is around 1-1.5 L in adults.

Functional residual capacity (FRC) is the volume of air remaining in the lungs after a normal exhalation. It is around 2.5-3 L in adults.

### Ventilation-Perfusion Ratio

**Ventilation** (V) is the amount of air that reaches the alveoli per minute. **Perfusion** (Q) is the amount of blood that reaches the alveoli per minute.

The ventilation-perfusion ratio (V/Q) is the ratio of alveolar ventilation to pulmonary blood flow. It is around 0.8 in healthy individuals.

The body tries to send blood to well-ventilated areas and send air to well-perfused areas to keep V/Q balanced. 

For example, the bottom of the lung receives more blood flow due to gravity, so it has a higher perfusion. The airway smooth muscles there are relaxed, increasing ventilation. 
