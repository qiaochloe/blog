...
tags:
- notes
todo: respiratory terms from lab 3
---
...
The **diastolic pressure curve** represents the passive filling of the ventricle and 
is impacted by how easily the ventricle stretches (compliance). 

The **systolic pressure curve** represents the resistance the ventricle must overcome to eject blood and is impacted by how strongly the ventricle contracts (contractility). Contractility is influenced by the Frank-Starling mechanism, which is affected by preload, afterload, and sympathetic tone.

Notice that the diastolic filling and systolic ejection phases are bounded by the diastolic and systolic pressure curves. The actual preload is determined by the venous return, and the actual afterload is determined by the arterial pressure and TPR.

Stroke volume is a combination of preload, afterload, and sympathetic tone.
...
**Pulse pressure** is how much pressure rises when the heart ejects blood. Increase capacitance of arteries decreases pulse pressure because it allows the arteries to stretch more and accommodate the ejected blood without a large increase in pressure.

Increased capacitance of the veins also decreases venous return, decreasing preload and thus stroke volume. 
...
3. Veins stiffen, decreasing their capacitance. This causes a greater increase in pressure when the muscles compress the veins, resulting in a greater venous return. As a result, preload increases, which increases stroke volume and cardiac output.
...
The **cardiac function curve** shows that as right atrial pressure increases, cardiac output increases.
...
The **vascular function curve** shows that as right atrial pressure increases, venous return decreases. 
...
Lungs tend to collapse inward due to their elastic properties, while the chest wall tends to expand outward. The pleural cavity between them has a negative pressure, which keeps the lungs inflated.

When the **diaphragm** and **intercostal muscles** contract, they expand the **thoracic cavity**, which decreases the pressure in the pleural cavity. This causes air to flow into the lungs. When the diaphragm and intercostal muscles relax, the thoracic cavity contracts, which increases the pressure in the pleural cavity. This causes air to flow out of the lungs.

**Pneumothorax** occurs when air enters the pleural space, removing the negative pressure. The lung collapses inwards and cannot expand.

**Question**: In room air, oxygen and carbon dioxide act exactly the same. However, oxygen dissolves very poorly in water, and it exerts 20x more partial pressure dissolved in water than CO2. How does blood carry enough oxygen?

Hemoglobin binds to the oxygen, decreasing its partial pressure in water and allowing more oxygen to dissolve in the blood. 
...
**Fibrotic lung disease.** The alveoli are thickened, so there is a longer diffusion distance for gas exchange. This also causes a decrease in PO2 in the blood.

**Pulmonary edema**. There is fluid in the alveoli, which increases the diffusion distance for gas exchange. This also causes a decrease in PO2 in the blood.
...
| Term | Definition |
| ---- | ---------- |
| Alveolar ventilation (VA) | Volume of air that reaches the alveoli per minute |
| Tidal volume (TV) | Volume of air inhaled or exhaled during normal breathing (500 mL)|
| Dead space | Volume of air that does not participate in gas exchange (150 mL) |
| Breathing frequency | Number of breaths per minute (12-20) |
| Vital capacity (VC) | Maximum amount of air that can be exhaled (3-5 L) |
| Total lung capacity (TLC) | Maximum amount of air the lungs can hold (6-7 L) |
| Residual volume (RV) | Volume of air remaining in the lungs after maximum exhalation (1-1.5 L) |
| Functional residual capacity (FRC) | Volume of air remaining in the lungs after normal exhalation (2.5-3 L) |

To calculate alveolar ventilation, we can use the following equation:
...
- $V_T$ is tidal volume
- $V_D$ is dead space volume
- $f$ is breathing frequency

### Ventilation-Perfusion Ratio

**Ventilation** (V) is the amount of air that reaches the alveoli per minute. **Perfusion** (Q) is the amount of blood that reaches the alveoli per minute. The ventilation-perfusion ratio (V/Q) is the ratio of alveolar ventilation to pulmonary blood flow. It is around 0.8 in healthy individuals.

The body tries to send blood to well-ventilated areas and send air to well-perfused areas to keep V/Q balanced. For example, the bottom of the lung receives more blood flow due to gravity, so it has a higher perfusion. The airway smooth muscles there are relaxed, increasing ventilation. 
...
The Bohr shift is the phenomenon where a decrease in pH (increase in H+ concentration) or an increase in CO2 concentration causes a rightward shift in the oxygen-hemoglobin dissociation curve. This means that hemoglobin has a lower affinity for oxygen, allowing more oxygen to be released to the tissues.
