...
- Respiratory alkalosis is caused by hyperventilation, which results in the loss of CO2. It can be compensated by decreased H+ secretion and decreased HCO3- reabsorption in the kidneys.
...
Typical arterial blood gas values are 26 mM/L HCO3- and 45 mmHg PCO2. 
...
The stomach digests food by secreting mucus, hydrochloric acid (HCI), digestive enzymes (pepsinogen, gastric lipase). Parietal cells secrete acid into the stomach. **D cells** in the stomach release **somatostatin**, which basically inhibit gastic acid, gastrin, and pepsinogen. 
...
4. **Glucagon-like peptide** (GLP-1 ) is triggered by carbs. It also stimulates pancreatic beta cells.
