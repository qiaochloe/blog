...
1. [Key Value Store](#-key-value-store)
    1. [Single Server](#single-server)
    2. [Distributed Server](#distributed-server)
    3. [Data Partitioning and Replication](#data-partitioning-and-replication)
...
2. [Unique ID Generator](#unique-id-generator)
